...
/**
 * [OutcomeWrapperService] — это сервис-обёртка над другим [OutcomeService],
 ...
 *    [OutcomeService] по этому имени в DI-контейнере Koin.
 ...
 * @param outcome имя целевого [OutcomeService], к которому подключаться удалённо.
 */
