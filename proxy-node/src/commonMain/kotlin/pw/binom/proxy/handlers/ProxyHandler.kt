...
import pw.binom.proxy.RuntimeProperties
...
class ProxyHandler : HttpHandler {
    ...
    val httpClient by lazy {
        ...
        val protocolSelector = SingleProtocolSelector(ProxedFactory(protocolSelector = baseProtocolSelector, channelProvider = { url ->
